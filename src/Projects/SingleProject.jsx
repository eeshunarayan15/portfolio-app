...
const SingleProject = ({ name, year, align, image, link }) => {
  return (
    <div
      className={`flex w-full max-[500px]:flex-col-reverse items-center gap-8 ${
        align === "left" ? "md:flex-row" : "md:flex-row-reverse"
      } justify-end`}
    >
      {/* Text Section */}
      <div>
        <h2 className="md:text-3xl max-[500px]:text-2xl text-orange-400">
          {name}
        </h2>
        <h2
          className={`text-xl font-thin text-white max-[500px]:text-center ${
        ...
        <a
          className={`text-lg flex gap-2 items-center text-cyan-400 hover:text-orange-400 transition-all duration-500 cursor-pointer max-[500px]:justify-self-center ${
